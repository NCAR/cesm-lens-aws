...
### Installing and Running the Notebooks in Jupyter
For those interested in running the notebook(s) in this repo within a Jupyter environment, the file `environment.yml` contains a conda environment description that should work for many Jupyter environments.
...
git clone https://github.com/NCAR/cesm-lens-aws.git
...
to change the installation folder.## ESM catalog
